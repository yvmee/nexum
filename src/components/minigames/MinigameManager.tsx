...
export const PAPERS_START: Paper[] = [ // Paper text data 
  { id: 1, title: 'Motivate Your Students!', text: 'Bring along **visual aid** or **establish a practical connection**.\n\n**Use your own enthusiasm** for the topic to interest the students in the subject and the content being covered.', 
      x: '60%', y: '40%', rotate: 25 },
  { id: 2, title: 'A Positive Atmosphere ', text: 'Create a **positive atmosphere** by approaching students with openness. Create eye contact and use open facial expressions and gestures. Take their wishes and concerns seriously. This is **not the place for fearmongering, irony or sarcasm**.', 
      x: '35%', y: '20%', rotate: 5 },
